...
>
> **IBM**: Issue observed where both IP and DNS are empty — workaround uses Hostname from KeyValueList as fallback. Reported to Spider; expected to be resolved in a future update (not tracked).
