...
const docTemplate = `{
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/pkg_api_rest_common.SimpleMessage"
                        }
                    },
                    "404": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/pkg_api_rest_controller.MigrateInfraRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/pkg_api_rest_controller.MigrateInfraResponse"
                        }
                    },
                    "404": {
                        "description": "Not Found",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/github_com_cloud-barista_cm-beetle_pkg_core_common.RestGetAllNsResponse"
                        }
                    },
                    "404": {
                        "description": "Not Found",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/pkg_api_rest_controller.RecommendInfraRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/pkg_api_rest_controller.RecommendInfraResponse"
                        }
                    },
                    "404": {
                        "description": "Not Found",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/pkg_api_rest_controller.GetUsersResponse"
                        }
                    },
                    "404": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/pkg_api_rest_controller.CreateUserRequest"
                        }
                    }
                ],
                "responses": {
                    "201": {
                        "description": "(Sample) This is a sample description for success response in Swagger UI",
                        "schema": {
                            "$ref": "#/definitions/pkg_api_rest_controller.GetUserResponse"
                        }
                    },
                    "400": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/pkg_api_rest_controller.UpdateUserRequest"
                        }
                    }
                ],
                "responses": {
                    "201": {
                        "description": "(Sample) This is a sample description for success response in Swagger UI",
                        "schema": {
                            "$ref": "#/definitions/pkg_api_rest_controller.UpdateUserResponse"
                        }
                    },
                    "400": {
                        "description": "Invalid Request",
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/pkg_api_rest_controller.PatchUserRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "(Sample) This is a sample description for success response in Swagger UI",
                        "schema": {
                            "$ref": "#/definitions/pkg_api_rest_controller.PatchUserResponse"
                        }
                    },
                    "400": {
                        "description": "Invalid Request",
    ...
    "definitions": {
        ...
        "github_com_cloud-barista_cm-beetle_pkg_core_common.RestGetAllNsResponse": {
            "type": "object",
            "properties": {
                "ns": {
        ...
        "pkg_api_rest_common.SimpleMessage": {
            "type": "object",
            "properties": {
                "message": {
                    "type": "string",
        ...
        "pkg_api_rest_controller.CreateUserRequest": {
            "type": "object",
            "properties": {
                "email": {
                    "type": "string"
        ...
        "pkg_api_rest_controller.GetUserResponse": {
            "type": "object",
            "properties": {
                "email": {
                    "type": "string"
        ...
        "pkg_api_rest_controller.GetUsersResponse": {
            "type": "object",
            "properties": {
                "users": {
                    "type": "array",
        ...
        "pkg_api_rest_controller.MigrateInfraRequest": {
            "type": "object",
            "required": [
                "name",
                "vm"
        ...
        "pkg_api_rest_controller.MigrateInfraResponse": {
            "type": "object",
            "required": [
                "name",
                "vm"
        ...
        "pkg_api_rest_controller.PatchUserRequest": {
            "type": "object",
            "properties": {
                "email": {
                    "type": "string"
        ...
        "pkg_api_rest_controller.PatchUserResponse": {
            "type": "object",
            "properties": {
                "email": {
                    "type": "string"
        ...
        "pkg_api_rest_controller.RecommendInfraRequest": {
            "type": "object",
            "required": [
                "servers"
            ],
        ...
        "pkg_api_rest_controller.RecommendInfraResponse": {
            "type": "object",
            "required": [
                "name",
                "vm"
        ...
        "pkg_api_rest_controller.UpdateUserRequest": {
            "type": "object",
            "properties": {
                "email": {
                    "type": "string"
        ...
        "pkg_api_rest_controller.UpdateUserResponse": {
            "type": "object",
            "properties": {
                "email": {
                    "type": "string"
