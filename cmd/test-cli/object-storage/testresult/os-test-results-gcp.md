...
- Test Time: 21:52:12 KST
- Test Execution: 2026-05-07 21:52:12 KST
...
|------|-------------------------------|--------|----------|----------|
| 1 | `POST /beetle/recommendation/middleware/objectStorage` | ✅ **PASS** | 3ms | Pass |
| 2 | `POST /beetle/migration/middleware/ns/mig01/objectStorage` | ✅ **PASS** | 28.109s | Pass |
| 3 | `GET /beetle/migration/middleware/ns/mig01/objectStorage` | ✅ **PASS** | 5ms | Pass |
| 4 | `HEAD /beetle/migration/middleware/ns/mig01/objectStorage/{{osId}}` | ✅ **PASS** | 1.753s | Pass |
| 5 | `GET /beetle/migration/middleware/ns/mig01/objectStorage/{{osId}}` | ✅ **PASS** | 3.524s | Pass |
| 6 | `DELETE /beetle/migration/middleware/ns/mig01/objectStorage/{{osId}}` | ✅ **PASS** | 21.045s | Pass |

**Overall Result**: 6/6 tests passed ✅

**Total Duration**: 59.44434243s

*Test executed on May 7, 2026 at 21:52:12 KST (2026-05-07 21:52:12 KST) using CM-Beetle automated test CLI*
