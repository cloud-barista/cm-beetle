# CM-Beetle test results for ALIBABA (object storage)

> [!NOTE]
> This document presents comprehensive test results for CM-Beetle object storage integration with ALIBABA.
...
- Test Time: 21:53:00 KST
- Test Execution: 2026-05-07 21:53:00 KST
...
|------|-------------------------------|--------|----------|----------|
| 1 | `POST /beetle/recommendation/middleware/objectStorage` | ✅ **PASS** | 11ms | Pass |
| 2 | `POST /beetle/migration/middleware/ns/mig01/objectStorage` | ✅ **PASS** | 24.712s | Pass |
| 3 | `GET /beetle/migration/middleware/ns/mig01/objectStorage` | ✅ **PASS** | 33ms | Pass |
| 4 | `HEAD /beetle/migration/middleware/ns/mig01/objectStorage/{{osId}}` | ✅ **PASS** | 527ms | Pass |
| 5 | `GET /beetle/migration/middleware/ns/mig01/objectStorage/{{osId}}` | ✅ **PASS** | 671ms | Pass |
| 6 | `DELETE /beetle/migration/middleware/ns/mig01/objectStorage/{{osId}}` | ✅ **PASS** | 6.32s | Pass |

**Overall Result**: 6/6 tests passed ✅

**Total Duration**: 37.28111574s

*Test executed on May 7, 2026 at 21:53:00 KST (2026-05-07 21:53:00 KST) using CM-Beetle automated test CLI*
