...
- Test Time: 18:49:27 KST
- Test Execution: 2026-06-17 18:49:27 KST
...
|------|-------------------------------|--------|----------|----------|
| 1 | `POST /beetle/recommendation/infra` | ✅ **PASS** | 12.933s | Pass |
| 2 | `POST /beetle/migration/ns/mig01/infra` | ✅ **PASS** | 8m30.247s | Pass |
| 3 | `GET /beetle/migration/ns/mig01/infra` | ✅ **PASS** | 40ms | Pass |
| 4 | `GET /beetle/migration/ns/mig01/infra?option=id` | ✅ **PASS** | 5ms | Pass |
| 5 | `GET /beetle/migration/ns/mig01/infra/{{infraId}}` | ✅ **PASS** | 37ms | Pass |
| 6 | Remote Command Accessibility Check | ✅ **PASS** | 0s | Pass |
| 7 | `GET /beetle/summary/target/ns/mig01/infra/{{infraId}}` | ✅ **PASS** | 5.278s | Pass |
| 8 | `POST /beetle/report/migration/ns/mig01/infra/{{infraId}}` | ✅ **PASS** | 5.32s | Pass |
| 9 | `DELETE /beetle/migration/ns/mig01/infra/{{infraId}}` | ✅ **PASS** | 9m1.853s | Pass |

**Overall Result**: 9/9 tests passed ✅

**Total Duration**: 19m8.658146535s

*Test executed on June 17, 2026 at 18:49:27 KST (2026-06-17 18:49:27 KST) using CM-Beetle automated test CLI*
  ...
  "vmResults": [
    {
      ...
      "nodeId": "my03-vm-ec268ed7-821e-9d73-e79f-961262161624-1",
      "output": "Linux tbj0m59deboc5kp16k9p 6.8.0-1060-gcp #63~22.04.1-Ubuntu SMP Wed May 27 08:12:44 UTC 2026 x86_64 x86_64 x86_64 GNU/Linux",
      "publicIP": "34.22.74.68",
      "sshTest": "successful",
      "status": "success",
      "testOrder": 1,
    ...
    },
    {
      ...
      "nodeId": "my03-vm-ec288dd0-c6fa-8a49-2f60-bc898311febf-1",
      "output": "Linux tb2956ehnjju5jlsdi3v 6.8.0-1060-gcp #63~22.04.1-Ubuntu SMP Wed May 27 08:12:44 UTC 2026 x86_64 x86_64 x86_64 GNU/Linux",
      "publicIP": "34.64.232.139",
      "sshTest": "successful",
      "status": "success",
      "testOrder": 2,
    ...
    },
    {
      ...
      "nodeId": "my03-vm-ec2d32b5-98fb-5a96-7913-d3db1ec18932-1",
      "output": "Linux tbt4i48pjotrbhdl9gs6 6.8.0-1060-gcp #63~22.04.1-Ubuntu SMP Wed May 27 08:12:44 UTC 2026 x86_64 x86_64 x86_64 GNU/Linux",
      "publicIP": "34.64.88.27",
      "sshTest": "successful",
      "status": "success",
      "testOrder": 3,
...
**Generated At:** 2026-06-17 09:58:15
...
|---------|-----------|--------|-------------------------|-------|------|
| my03-vm-ec268ed7-821e-9d73-e79f-961262161624-1 | tbj0m59deboc5kp16k9p | Running | 2 vCPU, 2.0 GiB | Canonical, Ubuntu, 22.04 LTS, amd64 jammy image built on 2026-05-30 (Canonical, Ubuntu, 22.04 LTS, amd64 jammy image built on 2026-05-30) | **VNet:** my03-vnet-01<br>**Subnet:** my03-subnet-01<br>**Public IP:** 34.22.74.68<br>**Private IP:** 10.0.1.3<br>**SGs:** my03-sg-01<br>**SSH:** my03-sshkey-01 |
| my03-vm-ec288dd0-c6fa-8a49-2f60-bc898311febf-1 | tb2956ehnjju5jlsdi3v | Running | 2 vCPU, 7.8 GiB | Canonical, Ubuntu, 22.04 LTS, amd64 jammy image built on 2026-05-30 (Canonical, Ubuntu, 22.04 LTS, amd64 jammy image built on 2026-05-30) | **VNet:** my03-vnet-01<br>**Subnet:** my03-subnet-01<br>**Public IP:** 34.64.232.139<br>**Private IP:** 10.0.1.4<br>**SGs:** my03-sg-03<br>**SSH:** my03-sshkey-01 |
| my03-vm-ec2d32b5-98fb-5a96-7913-d3db1ec18932-1 | tbt4i48pjotrbhdl9gs6 | Running | 4 vCPU, 15.6 GiB | Canonical, Ubuntu, 22.04 LTS, amd64 jammy image built on 2026-05-30 (Canonical, Ubuntu, 22.04 LTS, amd64 jammy image built on 2026-05-30) | **VNet:** my03-vnet-01<br>**Subnet:** my03-subnet-01<br>**Public IP:** 34.64.88.27<br>**Private IP:** 10.0.1.2<br>**SGs:** my03-sg-02<br>**SSH:** my03-sshkey-01 |
...
|----------|-------|
| **Name** | my03-vnet-01 |
| **CSP VNet ID** | tb55u0r7fui78keqmsu9 |
...
|------|---------------|------------|------|
| my03-subnet-01 | tbbd41snnf33mlvt1l64 | 10.0.1.0/24 |  |
...
|------|----------------|----------|-------------|
| my03-sshkey-01 | tb6gs4asldvc6ud5lskc |  |  |
...
|----------|-------|
| **Name** | my03-sg-01 |
| **CSP Security Group ID** | tb8dd9po10ieobbqqfu9 |
| **VNet** | my03-vnet-01 |
| **Rule Count** | 14 rules |
...
|----------|-------|
| **Name** | my03-sg-02 |
| **CSP Security Group ID** | tb2v1mt2qbk8c46s3qsv |
| **VNet** | my03-vnet-01 |
| **Rule Count** | 19 rules |
...
|----------|-------|
| **Name** | my03-sg-03 |
| **CSP Security Group ID** | tbocks1sfvd9h09b4fqe |
| **VNet** | my03-vnet-01 |
| **Rule Count** | 19 rules |
...
*Report generated: 2026-06-17 09:58:20*
...
|-----|-------------|---------------|
| 1 | **VM Name:** my03-vm-ec268ed7-821e-9d73-e79f-961262161624-1<br>**VM ID:** tbj0m59deboc5kp16k9p<br>**Label(sourceMachineId):** vm-ec268ed7-821e-9d73-e79f | **Hostname:** N/A<br>**Machine ID:** vm-ec268ed7-821e-9d73-e79f |
| 2 | **VM Name:** my03-vm-ec288dd0-c6fa-8a49-2f60-bc898311febf-1<br>**VM ID:** tb2956ehnjju5jlsdi3v<br>**Label(sourceMachineId):** vm-ec288dd0-c6fa-8a49-2f60 | **Hostname:** N/A<br>**Machine ID:** vm-ec288dd0-c6fa-8a49-2f60 |
| 3 | **VM Name:** my03-vm-ec2d32b5-98fb-5a96-7913-d3db1ec18932-1<br>**VM ID:** tbt4i48pjotrbhdl9gs6<br>**Label(sourceMachineId):** vm-ec2d32b5-98fb-5a96-7913 | **Hostname:** N/A<br>**Machine ID:** vm-ec2d32b5-98fb-5a96-7913 |
...
**CSP ID:** tb8dd9po10ieobbqqfu9 | **VNet:** my03-vnet-01 | **Rules:** 14
...
**CSP ID:** tb2v1mt2qbk8c46s3qsv | **VNet:** my03-vnet-01 | **Rules:** 19
...
**CSP ID:** tbocks1sfvd9h09b4fqe | **VNet:** my03-vnet-01 | **Rules:** 19
...
|-----|-----------|------------|
| 1 | **Name:** my03-vnet-01<br>**ID:** tb55u0r7fui78keqmsu9 | 10.0.0.0/21 |

### Subnets

| No. | Subnet | CIDR Block | Associated VPC(VNet) |
|-----|--------|------------|----------------------|
| 1 | **Name:** my03-subnet-01<br>**ID:** tbbd41snnf33mlvt1l64 | 10.0.1.0/24 | my03-vnet-01 |
...
|-----|--------------|------------|-------------|-------|
| 1 | my03-sshkey-01 | tb6gs4asldvc6ud5lskc |  | Used by all 3 VMs |
