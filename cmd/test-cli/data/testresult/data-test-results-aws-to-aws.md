...
- Test Time: 17:05:57 KST
- Test Execution: 2026-06-04 17:05:57 KST
...
|------|------------------------|--------|----------|---------|
| 1 | `POST /beetle/migration/middleware/ns/mig01/objectStorage` (target) | ✅ **PASS** | 1.766s | Pass |
| 2 | `POST /beetle/migration/data` (migrate: source OS → target OS, encrypted, async) | ✅ **PASS** | 10.176s | Pass |
| 3 | Verify migrated data (compare source and target object lists) | ✅ **PASS** | 588ms | Pass |
| 4 | `DELETE /beetle/migration/middleware/ns/mig01/objectStorage/{targetOsId}` (cleanup) | ✅ **PASS** | 5.379s | Pass |

**Overall Result**: 4/4 steps passed ✅

**Total Duration**: 23.916364436s

*Test executed on June 4, 2026 at 17:05:57 KST (2026-06-04 17:05:57 KST) using CM-Beetle automated test CLI*
...
- **Status**: ✅ **SUCCESS**
- **Duration**: 10.176s
- **Note**: Initial response was `202 Accepted` (status: `Handling`). The test CLI polled `GET /beetle/request/1780560365401939210` every 10s (timeout: 600s) until migration completed with status `Success`. Step 3 was then executed.
<details>
...
{
  "data": {
    "reqId": "1780560365401939210",
    "status": "Handling",
    "statusUrl": "/beetle/request/1780560365401939210"
  },
