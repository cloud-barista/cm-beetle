...
- Test Time: 17:08:12 KST
- Test Execution: 2026-06-04 17:08:12 KST
...
|------|------------------------|--------|----------|---------|
| 1 | `POST /beetle/migration/middleware/ns/mig01/objectStorage` (target) | ✅ **PASS** | 2.34s | Pass |
| 2 | `POST /beetle/migration/data` (migrate: source OS → target OS, encrypted, async) | ✅ **PASS** | 10.1s | Pass |
| 3 | Verify migrated data (compare source and target object lists) | ✅ **PASS** | 856ms | Pass |
| 4 | `DELETE /beetle/migration/middleware/ns/mig01/objectStorage/{targetOsId}` (cleanup) | ✅ **PASS** | 4.902s | Pass |

**Overall Result**: 4/4 steps passed ✅

**Total Duration**: 24.203290166s

*Test executed on June 4, 2026 at 17:08:12 KST (2026-06-04 17:08:12 KST) using CM-Beetle automated test CLI*
...
- **Status**: ✅ **SUCCESS**
- **Duration**: 10.1s
- **Note**: Initial response was `202 Accepted` (status: `Handling`). The test CLI polled `GET /beetle/request/1780560501130140621` every 10s (timeout: 600s) until migration completed with status `Success`. Step 3 was then executed.
<details>
...
{
  "data": {
    "reqId": "1780560501130140621",
    "status": "Handling",
    "statusUrl": "/beetle/request/1780560501130140621"
  },
