...
- Test Time: 16:26:19 KST
- Test Execution: 2025-10-02 16:26:19 KST
...
| ---- | ------------------------------------------------- | ----------- | --------- | ------- |
| 1    | `POST /beetle/recommendation/mci`                 | ✅ **PASS** | 527ms     | Pass    |
| 2    | `POST /beetle/migration/ns/mig01/mci`             | ✅ **PASS** | 2m42.433s | Pass    |
| 3    | `GET /beetle/migration/ns/mig01/mci`              | ✅ **PASS** | 455ms     | Pass    |
| 4    | `GET /beetle/migration/ns/mig01/mci?option=id`    | ✅ **PASS** | 69ms      | Pass    |
| 5    | `GET /beetle/migration/ns/mig01/mci/{{mciId}}`    | ✅ **PASS** | 359ms     | Pass    |
| 6    | Remote Command Accessibility Check                | ✅ **PASS** | 0s        | Pass    |
| 7    | `DELETE /beetle/migration/ns/mig01/mci/{{mciId}}` | ✅ **PASS** | 3m21.423s | Pass    |

**Overall Result**: 7/7 tests passed ✅

**Total Duration**: 6m43.025938654s

_Test executed on October 2, 2025 at 16:26:19 KST (2025-10-02 16:26:19 KST) using CM-Beetle automated test CLI_
    ...
    "subGroups": [
      {
        ...
        "imageId": "https://www.googleapis.com/compute/v1/projects/ubuntu-os-cloud/global/images/ubuntu-minimal-2204-jammy-v20250923",
        "vNetId": "mig-vnet-01",
  ...
  "targetVmOsImageList": [
    {
      "namespace": "system",
      "providerName": "gcp",
      "cspImageName": "https://www.googleapis.com/compute/v1/projects/ubuntu-os-cloud/global/images/ubuntu-minimal-2204-jammy-v20250923",
      "regionList": ["common"],
      "id": "https://www.googleapis.com/compute/v1/projects/ubuntu-os-cloud/global/images/ubuntu-minimal-2204-jammy-v20250923",
      "uid": "d3ct0tl9bnj93606vod0",
      "name": "https://www.googleapis.com/compute/v1/projects/ubuntu-os-cloud/global/images/ubuntu-minimal-2204-jammy-v20250923",
      "connectionName": "gcp-africa-south1",
      "infraType": "k8s|kubernetes|container",
      "fetchedTime": "2025.09.29 00:19:02 Mon",
      "isKubernetesImage": true,
      "isBasicImage": true,
      "osType": "Ubuntu 22.04",
      "osArchitecture": "x86_64",
      "osPlatform": "Linux/UNIX",
      "osDistribution": "Canonical, Ubuntu, 22.04 LTS Minimal, amd64 jammy minimal image built on 2025-09-23",
      "osDiskType": "NA",
      "osDiskSizeGB": 10,
      ...
      "details": [
        ...
        {
          "key": "CreationTimestamp",
          "value": "2025-09-24T09:51:24.210-07:00"
        },
        {
          "key": "Description",
          "value": "Canonical, Ubuntu, 22.04 LTS Minimal, amd64 jammy minimal image built on 2025-09-23"
        },
        {
          "key": "DiskSizeGb",
          "value": "10"
        ...
        {
          "key": "Name",
          "value": "ubuntu-minimal-2204-jammy-v20250923"
        },
        {
          "key": "RawDisk",
        ...
        {
          "key": "SelfLink",
          "value": "https://www.googleapis.com/compute/v1/projects/ubuntu-os-cloud/global/images/ubuntu-minimal-2204-jammy-v20250923"
        },
        {
          "key": "SourceType",
          "value": "RAW"
      ...
      "description": "Canonical, Ubuntu, 22.04 LTS Minimal, amd64 jammy minimal image built on 2025-09-23"
    }
  ],
  ...
  "vm": [
    {
      ...
      "uid": "d3f2j3d9bnj9364896fg",
      "cspResourceName": "d3f2j3d9bnj9364896fg",
      "cspResourceId": "d3f2j3d9bnj9364896fg",
      ...
      "systemMessage": "",
      "createdTime": "2025-10-02 07:28:56",
      "label": {
        "sourceMachineId": "0036e4b9-c8b4-e811-906e-000ffee02d5c"
      },
      "description": "a recommended virtual machine 02 for 0036e4b9-c8b4-e811-906e-000ffee02d5c",
      ...
      "cspImageName": "https://www.googleapis.com/compute/v1/projects/ubuntu-os-cloud/global/images/ubuntu-minimal-2204-jammy-v20250923",
      "vNetId": "mig-vnet-01",
      "cspVNetId": "d3f2i9t9bnj9364896b0",
      "subnetId": "mig-subnet-01",
      "cspSubnetId": "d3f2i9t9bnj9364896bg",
      "networkInterface": "nic0",
      "securityGroupIds": ["mig-sg-02"],
      "dataDiskIds": null,
      "sshKeyId": "mig-sshkey-01",
      "cspSshKeyId": "d3f2ii59bnj9364896c0",
      "vmUserName": "cb-user",
      "commandStatus": [
        {
          "index": 1,
          ...
          "status": "Completed",
          "startedTime": "2025-10-02T07:29:02Z",
          "completedTime": "2025-10-02T07:29:03Z",
          "elapsedTime": 1,
          "resultSummary": "Command executed successfully",
          "stdout": "Linux d3f2j3d9bnj9364896fg 6.8.0-1040-gcp #42~22.04.1-Ubuntu SMP Tue Sep  9 13:30:57 UTC 2025 x86_64 x86_64 x86_64 GNU/Linux\n\n",
          "stderr": "\n"
        }
      ],
      "addtionalDetails": [
        ...
        {
          "key": "CreationTimestamp",
          "value": "2025-10-02T00:28:16.310-07:00"
        },
        {
        ...
        {
          "key": "Labels",
          "value": "{keypair:d3f2ii59bnj9364896c0}"
        },
        {
          "key": "LastStartTimestamp",
          "value": "2025-10-02T00:28:26.834-07:00"
        },
        {
          "key": "MachineType",
          "value": "https://www.googleapis.com/compute/v1/projects/ykkim-etri/zones/asia-northeast3-a/machineTypes/e2-standard-4"
        ...
        {
          "key": "Metadata",
          "value": "{fingerprint:0J2cKhHA2dE=,items:[{key:ssh-keys,value:cb-user:ssh-rsa  cb-user}],kind:compute#metadata}"
        },
        {
          "key": "Name",
          "value": "d3f2j3d9bnj9364896fg"
        },
        {
          "key": "NetworkInterfaces",
          "value": "{accessConfigs:[{kind:compute#accessConfig,name:External NAT,natIP:34.22.110.67,networkTier:PREMIUM,type:ONE_TO_ONE_NAT}],fingerprint:G4kFdztP1EI=,kind:compute#networkInterface,name:nic0,network:https://www.googleapis.com/compute/v1/projects/ykkim-etri/global/networks/d3f2i9t9bnj9364896b0,networkIP:192.168.110.2,stackType:IPV4_ONLY,subnetwork:https://www.googleapis.com/compute/v1/projects/ykkim-etri/regions/asia-northeast3/subnetworks/d3f2i9t9bnj9364896bg}"
        },
        {
          "key": "ResourceStatus",
          "value": "{}"
        ...
        {
          "key": "SelfLink",
          "value": "https://www.googleapis.com/compute/v1/projects/ykkim-etri/zones/asia-northeast3-a/instances/d3f2j3d9bnj9364896fg"
        },
        {
          "key": "ServiceAccounts",
        ...
        {
          "key": "Tags",
          "value": "{fingerprint:N-7rDFNh5o8=,items:[d3f2iu59bnj9364896d0]}"
        },
        {
          "key": "Zone",
    ...
    },
    {
      ...
      "uid": "d3f2j3d9bnj9364896eg",
      "cspResourceName": "d3f2j3d9bnj9364896eg",
      "cspResourceId": "d3f2j3d9bnj9364896eg",
      ...
      "networkAgentStatus": "notInstalled",
      "systemMessage": "",
      "createdTime": "2025-10-02 07:28:55",
      "label": {
        "sourceMachineId": "00a9f3d4-74b6-e811-906e-000ffee02d5c"
      },
      "description": "a recommended virtual machine 01 for 00a9f3d4-74b6-e811-906e-000ffee02d5c",
      ...
      "commandStatus": [
        {
          ...
          "elapsedTime": 1,
          "resultSummary": "Command executed successfully",
          "stdout": "Linux d3f2j3d9bnj9364896eg 6.8.0-1040-gcp #42~22.04.1-Ubuntu SMP Tue Sep  9 13:30:57 UTC 2025 x86_64 x86_64 x86_64 GNU/Linux\n\n",
          "stderr": "\n"
        }
      ],
      "addtionalDetails": [
        ...
        {
          "key": "CreationTimestamp",
          "value": "2025-10-02T00:28:19.220-07:00"
        },
        {
          "key": "DeletionProtection",
          "value": "false"
        ...
        {
          "key": "Disks",
          "value": "{architecture:X86_64,autoDelete:true,boot:true,deviceName:persistent-disk-0,diskSizeGb:30,guestOsFeatures:[{type:VIRTIO_SCSI_MULTIQUEUE},{type:SEV_CAPABLE},{type:SEV_SNP_CAPABLE},{type:SEV_LIVE_MIGRATABLE},{type:SEV_LIVE_MIGRATABLE_V2},{type:IDPF},{type:TDX_CAPABLE},{type:UEFI_COMPATIBLE},{type:GVNIC}],interface:SCSI,kind:compute#attachedDisk,licenses:[https://www.googleapis.com/compute/v1/projects/ubuntu-os-cloud/global/licenses/ubuntu-minimal-2204-lts],mode:READ_WRITE,shieldedInstanceInitialState:{dbxs:[{content:_JbnlcVst9wtFK8NQjTpeB9wirml3h-fzi8vzki0hSNBD2Dg49lGEvs4egyowmTsLu1TnBUH1f_Hi8Noa7fKXV6F93qYrTPajx5v9L7NedplWnMEPsRvJrQdrysTZwtoXMLYDhc8bQHI5nlJDfgqrB8JiC4A3vL9i19lkQOTq4PZb5AcVcE0wlG7lR_btoQN0g5B4_7pI2S_9mU1PXr1NBSEl48Kl4cJwO2GyvOVvxQ6wUSFTExmCBKrT3LnPU5lZY68n3MpZ5VY4skhrEt2dyf5bZNzkYTTouxC0n37OrMbGGq3tpv7JDD6E_Rfqua3dXYECAwEAAaOCAXIwggFuMBQGA1UdJQQNMAsGCSsGAQQBgjdPATAdBgNVHQ4EFgQUVsJIppTfox2XYoAJRIlnxAUOy2owUQYDVR0RBEowSKRGMEQxDTALBgNVBAsTBE1PUFIxMzAxBgNVBAUTKjMxNjMxKzJjNDU2Y2JjLTA1NDItNDdkOS05OWU1LWQzOWI4MTVjNTczZTAfBgNVHSMEGDAWgBRi__zJSOS_JY6HkWZr6dDJe9Lj7xiW_e4qPP-KDrCVb02vBnK4EktVjTdJpyMhxBMdXUcq1eGl6518oCkQ27tu0-WZjaWEVsEY_gpQj0ye2UA4HYUYgJlpT24oJRi7TeQ03Nebb-ZrUkbf9uxl0OVV_-tVyawJsPq5_tXekQCXQcN2krldCrmsA_sbevsf7njWmMyfBEXTw7jC6c4FZOOxvXghLGamyzn9beR1gnh4sAEqKwwHN9I8wZQmmSnUX_IhU-PIIbO_i_hn_-CwO3pzc70U2piOgtDueIl_f4F-dTEFKsR4iOJjXC3pB1N7K7lnPoWwtfBy9ToxC_lme4kiwPsjfKL6sNK-0MREgt-tUeSbNzmBInr9TME6xABKnHl-YMTPP8lCS9odkb_uk--3K1xKliq-w7SeT3km2U7zCkqn_xyWaLrrpLv9jUTgM
        ...
        {
          "key": "Name",
          "value": "d3f2j3d9bnj9364896eg"
        },
        {
          "key": "NetworkInterfaces",
          "value": "{accessConfigs:[{kind:compute#accessConfig,name:External NAT,natIP:34.64.141.243,networkTier:PREMIUM,type:ONE_TO_ONE_NAT}],fingerprint:mg9u7J5S5dY=,kind:compute#networkInterface,name:nic0,network:https://www.googleapis.com/compute/v1/projects/ykkim-etri/global/networks/d3f2i9t9bnj9364896b0,networkIP:192.168.110.3,stackType:IPV4_ONLY,subnetwork:https://www.googleapis.com/compute/v1/projects/ykkim-etri/regions/asia-northeast3/subnetworks/d3f2i9t9bnj9364896bg}"
        },
        {
          "key": "ResourceStatus",
          "value": "{}"
        ...
        {
          "key": "SelfLink",
          "value": "https://www.googleapis.com/compute/v1/projects/ykkim-etri/zones/asia-northeast3-a/instances/d3f2j3d9bnj9364896eg"
        },
        {
          "key": "ServiceAccounts",
          "value": "{email:kimy-service-account@ykkim-etri.iam.gserviceaccount.com,scopes:[https://www.googleapis.com/auth/devstorage.full_control,https://www.googleapis.com/auth/compute]}"
        ...
        {
          "key": "Tags",
          "value": "{fingerprint:8AkPE45vYxs=,items:[d3f2ij59bnj9364896cg]}"
        },
        {
          "key": "Zone",
          "value": "https://www.googleapis.com/compute/v1/projects/ykkim-etri/zones/asia-northeast3-a"
    ...
    "results": [
      {
        ...
        "stdout": {
          "0": "Linux d3f2j3d9bnj9364896fg 6.8.0-1040-gcp #42~22.04.1-Ubuntu SMP Tue Sep  9 13:30:57 UTC 2025 x86_64 x86_64 x86_64 GNU/Linux\n"
        },
        "stderr": {
          "0": ""
        },
      ...
      },
      {
        ...
        "stdout": {
          "0": "Linux d3f2j3d9bnj9364896eg 6.8.0-1040-gcp #42~22.04.1-Ubuntu SMP Tue Sep  9 13:30:57 UTC 2025 x86_64 x86_64 x86_64 GNU/Linux\n"
        },
        "stderr": {
          "0": ""
        },
      ...
      "vm": [
        {
          ...
          "label": {
            ...
            "sys.createdTime": "2025-10-02 07:28:56",
            "sys.cspResourceId": "d3f2j3d9bnj9364896fg",
            "sys.cspResourceName": "d3f2j3d9bnj9364896fg",
        ...
        },
        {
          ...
          "label": {
            "sourceMachineId": "00a9f3d4-74b6-e811-906e-000ffee02d5c",
            "sys.connectionName": "gcp-asia-northeast3",
            "sys.createdTime": "2025-10-02 07:28:55",
            "sys.cspResourceId": "d3f2j3d9bnj9364896eg",
            "sys.cspResourceName": "d3f2j3d9bnj9364896eg",
...
```json
{
  ...
  "vmResults": [
    {
      "command": "uname -a",
      "output": "Linux d3f2j3d9bnj9364896fg 6.8.0-1040-gcp #42~22.04.1-Ubuntu SMP Tue Sep  9 13:30:57 UTC 2025 x86_64 x86_64 x86_64 GNU/Linux",
      "publicIP": "34.22.110.67",
      "sshTest": "successful",
      "status": "success",
    ...
    {
      "command": "uname -a",
      "output": "Linux d3f2j3d9bnj9364896eg 6.8.0-1040-gcp #42~22.04.1-Ubuntu SMP Tue Sep  9 13:30:57 UTC 2025 x86_64 x86_64 x86_64 GNU/Linux",
      "publicIP": "34.64.141.243",
      "sshTest": "successful",
      "status": "success",
