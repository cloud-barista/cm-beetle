    ...
    "definitions": {
        ...
        "transx.MinIOConfig": {
            ...
            "properties": {
                ...
                "endpoint": {
                    "description": "S3-compatible storage endpoint (e.g., \"s3.amazonaws.com\", \"play.min.io:9000\")",
                    "type": "string"
                },
                "region": {
                ...
                "useSSL": {
                    "description": "Use HTTPS for connections (default: true)",
                    "type": "boolean",
                    "default": true
                }
            }
        ...
        "transx.ObjectStorageOption": {
            ...
            "properties": {
                "client": {
                    "description": "Client selection (required)",
                    "type": "string",
                    "enum": [
                        "spider",
                        "minio",
                ...
                "minioConfig": {
                    "description": "Client-specific configurations (provide only one based on Client field)",
                    "allOf": [
                        {
                            "$ref": "#/definitions/transx.MinIOConfig"
                        }
                    ]
                },
                "spiderConfig": {
                    "description": "CB-Spider client configuration (for Client=\"spider\")",
                    "allOf": [
                        {
                ...
                "timeout": {
                    "description": "Common HTTP request configuration (optional)",
                    "type": "integer",
                    "default": 300
                },
                "tumblebugConfig": {
                    "description": "CB-Tumblebug client configuration (for Client=\"tumblebug\")",
                    "allOf": [
                        {
        ...
        "transx.SpiderConfig": {
            ...
            "properties": {
                "connectionName": {
                    "description": "CB-Spider connection name (e.g., \"aws-config01\", \"aws-ap-northeast-2\")",
                    "type": "string"
                },
                "endpoint": {
                    "description": "CB-Spider API endpoint (e.g., \"http://localhost:1024/spider/s3\")",
                    "type": "string"
                },
                "expires": {
        ...
        "transx.TumblebugConfig": {
            ...
            "properties": {
                "endpoint": {
                    "description": "CB-Tumblebug API endpoint (e.g., \"http://localhost:1323/tumblebug/objectstorage\")",
                    "type": "string"
                },
                "expires": {
                    "description": "Presigned URL expiration time in seconds (default: 3600)",
                ...
                "nsId": {
                    "description": "Namespace ID for multi-tenancy support",
                    "type": "string"
                },
                "osId": {
                    "description": "Object Storage ID configured in Tumblebug",
                    "type": "string"
                }
            }
        }
