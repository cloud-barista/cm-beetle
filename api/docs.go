...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/migration/data": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Data migration request (supports plaintext or encrypted with encryptionKeyId)",
                        "name": "reqBody",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/migration/data/encryptionKey": {
            "get": {
                ...
                "operationId": "GetDataMigrationEncryptionKey",
                "parameters": [
                    {
                        "type": "string",
                        "description": "Unique request ID (auto-generated if not provided). Used for tracking request status and correlating logs.",
        ...
        "/migration/data/test/decrypt": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Encrypted data migration model",
                        "name": "reqBody",
                        "in": "body",
                        "required": true,
                        "schema": {
                ...
                "responses": {
                    "200": {
                        "description": "Decrypted model (sensitive fields restored)",
                        "schema": {
                            "$ref": "#/definitions/model.ApiResponse-transx_DataMigrationModel"
                        }
                    },
                    "400": {
                        "description": "Decryption failed or model not encrypted",
                        "schema": {
                            "$ref": "#/definitions/model.ApiResponse-any"
                        }
                    }
        ...
        "/migration/data/test/encrypt": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Public key bundle and plaintext model",
                        "name": "reqBody",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/model.EncryptionTestRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "Encrypted model with encryptionKeyId set",
                        "schema": {
                            "$ref": "#/definitions/model.ApiResponse-transx_DataMigrationModel"
                        }
                    },
        ...
        "/migration/middleware/ns/{nsId}/infra/{infraId}/nlb": {
            "get": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/model.ApiResponse-array_cloudmodel_NLBInfo"
                        }
                    },
                    "400": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "boolean",
                        "description": "Reuse existing NLB if one targeting the same nodeGroupId already exists, instead of creating a new one (default: true)",
                        "name": "useExisting",
                        "in": "query"
                    },
                    {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/model.ApiResponse-cloudmodel_NLBInfo"
                        }
                    },
                    "400": {
                        "description": "Invalid request parameters",
        ...
        "/migration/middleware/ns/{nsId}/infra/{infraId}/nlb/{nlbId}/healthz": {
            "get": {
                "description": "Perform a live health check on NLB backend targets via the CSP.\nUnlike GET /nlb/{nlbId} (which returns cached state), this endpoint queries the CSP directly\nto retrieve the current health status of VM targets in the NLB target group.",
                "consumes": [
                    "application/json"
                ],
                "produces": [
                ...
                "responses": {
                    "200": {
                        "description": "NLB health info (live from CSP)",
                        "schema": {
                            "$ref": "#/definitions/model.ApiResponse-cloudmodel_NLBInfo"
                        }
                    },
        ...
        "/migration/middleware/ns/{nsId}/rdbms/validate": {
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "Successfully validated RDBMS creation configuration",
                        "schema": {
        ...
        "/migration/ns/{nsId}/infra": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "boolean",
                        "description": "Reuse existing resources (VNet, SSH Key, Security Group) if they already exist, instead of creating new ones (default: true)",
                        "name": "useExisting",
                        "in": "query"
                    },
                    {
        ...
        "/naming/alignment": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Current name of the resource (before change)",
                        "name": "oldName",
                        "in": "query",
                        "required": true
                    },
                    {
                        "type": "string",
                        "description": "New name of the resource (after change)",
                        "name": "newName",
                        "in": "query",
                        "required": true
                    },
                    {
                        "description": "The recommendation model to update",
                        "name": "UserInfra",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/naming/validation": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "The recommendation model to validate",
                        "name": "UserInfra",
                        "in": "body",
                        "required": true,
                        "schema": {
                ...
                "responses": {
                    "200": {
                        "description": "Naming and referential integrity are valid",
                        "schema": {
                            "$ref": "#/definitions/model.ApiResponse-any"
                        }
                    },
                    "400": {
                        "description": "Referential integrity validation failure",
                        "schema": {
                            "$ref": "#/definitions/model.ApiResponse-any"
                        }
                    }
        ...
        "/recommendation/middleware/rdbms/capability": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Database Engine filter (e.g., mysql, mariadb)",
                        "name": "dbEngine",
                        "in": "query"
                    }
                ],
        ...
        "/recommendation/middleware/rdbms/validate": {
            "post": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "default": "mig01",
                        "description": "Namespace ID (defaults to 'mig01')",
                        "name": "nsId",
                        "in": "query"
                    },
                    {
                ...
                "responses": {
                    "200": {
                        "description": "Successfully validated RDBMS configuration",
                        "schema": {
                            "$ref": "#/definitions/model.ApiResponse-rdbmsmodel_RDBMSCreateRequest"
                        }
                    },
        ...
        "/request/{reqId}": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Request ID (from X-Request-Id header of a previous Beetle API call)",
                        "name": "reqId",
                        "in": "path",
                        "required": true
                    }
            ...
            "delete": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Request ID to delete (from X-Request-Id header of a previous Beetle API call)",
                        "name": "reqId",
                        "in": "path",
                        "required": true
                    }
        ...
        "/test/streaming": {
            "get": {
                ...
                "operationId": "TestStreamingResponse",
                "responses": {
                    "200": {
                        "description": "Multiple JSON objects",
                        "schema": {
                            "type": "object",
        ...
        "/test/tracing": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "W3C Trace Context (e.g., 00-4bf92f3577b34da6a3ce929d0e0e4736-00f067aa0ba902b7-01). Used for distributed tracing.",
                        "name": "traceparent",
                        "in": "header"
                    },
                    {
                        "type": "string",
                        "description": "Unique request ID. Used for tracking request status and correlating logs.",
                        "name": "X-Request-Id",
                        "in": "header"
                    }
                ],
    ...
    "definitions": {
        ...
        "cloudmodel.MigratedNlbResult": {
            ...
            "properties": {
                ...
                "nlbList": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/cloudmodel.NLBInfo"
                    }
                },
                "status": {
        ...
        "cloudmodel.NLBHealthCheckerInfo": {
            "type": "object",
            "properties": {
                "interval": {
                    "type": "integer"
        ...
        "cloudmodel.NLBInfo": {
            ...
            "properties": {
                ...
                "healthChecker": {
                    "$ref": "#/definitions/cloudmodel.NLBHealthCheckerInfo"
                },
                "id": {
                    "type": "string"
                },
                ...
                "listener": {
                    "$ref": "#/definitions/cloudmodel.NLBListenerInfo"
                },
                "location": {
                ...
                "targetGroup": {
                    "$ref": "#/definitions/cloudmodel.NLBTargetGroupInfo"
                },
                "type": {
                    "type": "string"
                },
        ...
        "cloudmodel.ProvisioningFailure": {
            "type": "object",
            "properties": {
                "attemptedZone": {
                    "description": "AttemptedZone is the zone CB-Tumblebug actually requested, recorded from\nthe request itself. Authoritative: several CSPs (e.g. Alibaba) never name\nthe zone in their error text.",
                    "type": "string",
                    "example": "us-west-2a"
                },
                "class": {
                    "description": "Class is one of the Failure* constants.",
                    "type": "string",
                    "example": "ZoneCapacity"
                },
                "cspErrorCode": {
                    "description": "CspErrorCode is the provider's own error identifier when one could be\nextracted (e.g. \"InsufficientInstanceCapacity\", \"STOCKOUT\").",
                    "type": "string",
                    "example": "InsufficientInstanceCapacity"
                },
                "httpStatus": {
                    "type": "integer",
                    "example": 500
                ...
                "message": {
                    "description": "Message is a single-line human-readable summary.",
                    "type": "string"
                },
                "occurredAt": {
                    "type": "string"
                ...
                "retryHint": {
                    "description": "RetryHint is one of the RetryHint* constants.",
                    "type": "string",
                    "example": "differentZone"
                },
                "retryable": {
                    "description": "Retryable reports whether retrying can plausibly succeed without the\nuser changing something (quota increase, different spec).",
                    "type": "boolean",
                    "example": true
                },
                "source": {
                    "type": "string",
                    "example": "cb-spider:1024/spider/vm"
                },
                "suggestedZones": {
                    "description": "SuggestedZones are alternatives the CSP itself offered. Only AWS provides\nthese today; empty for every other provider.",
                    "type": "array",
                    "items": {
                        "type": "string"
                    },
        ...
        "model.ApiResponse-array_cloudmodel_NLBInfo": {
            "type": "object",
            "properties": {
                "data": {
                    "description": "Contains the actual response data (single object, list, or page)",
        ...
        "model.ApiResponse-cloudmodel_NLBInfo": {
            "type": "object",
            "properties": {
                "data": {
                    "description": "Contains the actual response data (single object, list, or page)",
        ...
        "model.ApiResponse-transx_DataMigrationModel": {
            "type": "object",
            "properties": {
                "data": {
                    "description": "Contains the actual response data (single object, list, or page)",
        ...
        "model.ApiResponse-transx_PublicKeyBundle": {
            "type": "object",
            "properties": {
                "data": {
                    "description": "Contains the actual response data (single object, list, or page)",
        ...
        "model.EncryptionTestRequest": {
            "type": "object",
            "properties": {
                "model": {
                    "description": "Model is the plaintext DataMigrationModel to be encrypted",
                    "allOf": [
                        {
                            "$ref": "#/definitions/transx.DataMigrationModel"
                        }
                ...
                "publicKeyBundle": {
                    "description": "PublicKeyBundle contains the public key obtained from GET /migration/data/encryptionKey",
                    "allOf": [
                        {
                            "$ref": "#/definitions/transx.PublicKeyBundle"
                        }
        ...
        "rdbmsmodel.RDBMSDBInstanceSpecInfo": {
            "type": "object",
            "properties": {
                "memSizeMiB": {
                    "type": "string",
        ...
        "rdbmsmodel.RDBMSDBMSRequirement": {
            ...
            "properties": {
                ...
                "deprecatedVersions": {
                    "description": "DeprecatedVersions lists engine versions that are deprecated by the CSP and discouraged for new deployments.",
                    "type": "array",
                    "items": {
                        "type": "string"
                    }
                ...
                "endOfLifeVersions": {
                    "description": "EndOfLifeVersions lists engine versions that have reached official End of Life (EOL) and cannot be provisioned.",
                    "type": "array",
                    "items": {
                        "type": "string"
                    }
        ...
        "rdbmsmodel.RDBMSMetaInfo": {
            ...
            "properties": {
                ...
                "dbInstanceSpecs": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/rdbmsmodel.RDBMSDBInstanceSpecInfo"
                    }
                },
                "dbOperationMethod": {
                    "type": "string",
                ...
                "notes": {
                    "$ref": "#/definitions/rdbmsmodel.RDBMSNotes"
                },
                "providerName": {
                    "type": "string",
                    "example": "aws"
        ...
        "transx.DataLocation": {
            ...
            "properties": {
                "filesystem": {
                    "description": "Access configuration (one of the following based on StorageType)",
                    "allOf": [
                        {
                            "$ref": "#/definitions/transx.FilesystemAccess"
                        }
                    ]
                },
                "filter": {
                    "description": "Filter defines file filtering options",
                    "allOf": [
                        {
                ...
                "objectStorage": {
                    "description": "For storageType=\"objectstorage\"",
                    "allOf": [
                        {
                            "$ref": "#/definitions/transx.ObjectStorageAccess"
                        }
                    ]
                },
                "path": {
                ...
                "postCmd": {
                    "description": "Command to run after transfer (destination only)",
                    "type": "string"
                },
                "preCmd": {
                    "description": "Hooks for pre/post processing",
                    "type": "string"
                },
                "storageType": {
                    "description": "StorageType: What kind of storage\n\"filesystem\": Local or remote filesystem\n\"objectstorage\": S3-compatible object storage",
                    "type": "string",
                    "enum": [
                        "filesystem",
                        "objectstorage"
        ...
        "transx.FilesystemAccess": {
            ...
            "properties": {
                ...
                "ssh": {
                    "description": "SSH configuration (required when accessType=\"ssh\")",
                    "allOf": [
                        {
                            "$ref": "#/definitions/transx.SSHConfig"
                        }
                    ]
                }
            }
        ...
        "transx.ObjectStorageAccess": {
            ...
            "properties": {
                ...
                "minio": {
                    "description": "Provider-specific configurations (one required based on accessType)",
                    "allOf": [
                        {
                            "$ref": "#/definitions/transx.S3MinioConfig"
                        }
                    ]
                },
                "spider": {
                    "description": "For accessType=\"spider\"",
                    "allOf": [
                        {
                            "$ref": "#/definitions/transx.SpiderConfig"
                        }
                    ]
                },
                "tumblebug": {
                    "description": "For accessType=\"tumblebug\"",
                    "allOf": [
                        {
                            "$ref": "#/definitions/transx.TumblebugConfig"
                        }
                    ]
                }
            }
        },
        "transx.PublicKeyBundle": {
            "type": "object",
            "properties": {
                "algorithm": {
                    "type": "string"
        ...
        "transx.SSHConfig": {
            ...
            "properties": {
                ...
                "privateKey": {
                    "description": "Authentication (priority: PrivateKey \u003e PrivateKeyPath \u003e Agent \u003e none)\nAt least one authentication method should be available.\n\nPrivateKey: PEM-encoded private key content (preferred for injected secrets).\nIn JSON, use single line with \\n for newlines:\n  \"privateKey\": \"-----BEGIN RSA PRIVATE KEY-----\\nMIIE...\\n-----END RSA PRIVATE KEY-----\"",
                    "type": "string"
                },
                "privateKeyPath": {
                    "description": "Path to private key file (legacy, prefer PrivateKey)",
                    "type": "string"
                },
                "useAgent": {
                    "description": "Use SSH agent for authentication (supports agent forwarding)",
                    "type": "boolean"
                },
                "username": {
                    "type": "string"
    ...
    "tags": [
        {
            "description": "APIs for system management (health check, metrics, etc.)",
            "name": "[Admin] System management"
        },
        {
            "description": "APIs for managing API requests (list, cancel, etc.)",
